...
"""
    This module has been added to extend the filegroup from function by allowing
    one or more filegroup content be copied between packages. This is especially
    useful when using "third_party" files.
"""

def _copy_file_groups_impl(ctx):
    """ Copys a file group to the current project and adds a prefix if specified."""
    input_files = [
        f
