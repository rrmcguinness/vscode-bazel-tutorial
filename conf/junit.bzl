...
def junit_jupiter_java_repositories(
    ...
    Args:
        version (sring): Specifies the version of junit to use, defaults to 5.9.0
    """
...
def junit_platform_java_repositories(
    ...
    Args:
        version (string): species the reposiroy version, default is 1.13.2
    """
...
def java_junit5_test(name, srcs, test_package, deps = [], runtime_deps = [], **kwargs):
    ...
    Args:
        ...
        test_package (string): a string test package
